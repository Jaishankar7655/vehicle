    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8">
          <h1 className="text-3xl font-bold mb-4">Car AC Repair & Services</h1>
        ...
        <div className="p-8">
          <p className="text-gray-600 leading-relaxed mb-8">
            Car lights and fittings play crucial roles in ensuring safety,
            visibility, and communication between drivers on the road. Each type
            of light has a specific function. For example, headlights are
            essential for illuminating the road ahead, especially at night or in
            low-visibility conditions, while fog lights are designed to reduce
            glare and improve visibility in foggy environments, usually mounted
            lower to the ground to prevent light from bouncing back from mist or
            snow{" "}
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">1-2 hours</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
