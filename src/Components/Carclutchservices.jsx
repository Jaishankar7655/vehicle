    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8">
          <h1 className="text-3xl font-bold mb-4">Car Clutch & Body Parts Services
          </h1>
        ...
        <div className="p-8">
          ...
          Car clutch and body parts services involve the repair, replacement, and maintenance of critical components that ensure a vehicle operates smoothly. The clutch system is essential for manual transmissions, and services include diagnosing issues, adjusting or replacing the clutch assembly, and ensuring proper operation. Body parts services focus on repairing or replacing damaged panels, bumpers, and other exterior components to maintain the vehicle's structural integrity and aesthetic appeal.</p>
          {/* Service Details */}
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">Car Clutch & Body Parts Services</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">3-6 hours or longer depending on damage</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
...
export default Carclutchservices;