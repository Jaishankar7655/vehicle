    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8">
          <h1 className="text-3xl font-bold mb-4">Car Tyre & Wheel Services</h1>
        ...
        <div className="p-8">
          ...
          Car Tyre & Wheel Services provide comprehensive solutions for tyre maintenance, including wheel balancing, alignment, tyre rotation, and replacement. Whether it's routine tyre checks or addressing issues like uneven wear or punctures, these services ensure that your car's tyres and wheels are in optimal condition, improving safety and driving comfort. Professional technicians offer expert advice on tyre care and replacement to enhance vehicle performance and longevity.          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">Car Tyre & Wheel Services</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600"> 1-5 hours depending on the issue</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">Moderate (depends on type of tyre and service)</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              <Car className="w-6 h-6 text-red-600" />
