    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8">
          <h1 className="text-3xl font-bold mb-4">Car Mechanical Repairs</h1>
          <div className="flex items-center text-2xl font-bold">
            <span className="text-4xl">₹</span>
            <span className="text-4xl ml-1">499</span>
        ...
        <div className="p-8">
          ...
          Car mechanical repairs encompass a broad spectrum of services aimed at diagnosing and fixing vehicle issues. Skilled technicians evaluate engine performance, brake functionality, and transmission efficiency to ensure safe operation. The repair process often begins with a thorough inspection, where mechanics identify problems and recommend appropriate solutions, ensuring vehicles meet safety and performance standards.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600"> Car Mechanical Repairs</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
            ...
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">Varies based on issue</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              <Car className="w-6 h-6 text-red-600" />
