    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8">
          <h1 className="text-3xl font-bold mb-4">Car Inspections
        ...
        <div className="p-8">
          ...
          Car inspections are a crucial aspect of vehicle maintenance, ensuring safety and compliance with local regulations. Qualified technicians perform thorough evaluations of key systems, including brakes, tires, lights, and emissions, Car Inspections identifying potential issues that may Car Inspections compromise safety. Regular inspections are essential for maintaining optimal vehicle performance and longevity.</p>
          {/* Service Details */}
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-600">Car Inspections</span>
              </div>
            </div>
            <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-lg">
