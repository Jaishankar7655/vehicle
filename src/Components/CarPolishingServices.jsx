    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8">
          <h1 className="text-3xl font-bold mb-4">Car Polishing Services
          </h1>
        ...
        <div className="p-8">
          ...
          Car polishing services focus on restoring a vehicles exterior by removing imperfections and enhancing its shine. The process involves using specialized compounds and buffing techniques to eliminate scratches, oxidation, and swirl marks, significantly improving the cars appearance. Professional detailers assess the vehicles condition before selecting the appropriate products and methods for optimal results.</p>
          {/* Service Details */}
...
export default CarPolishingServices;